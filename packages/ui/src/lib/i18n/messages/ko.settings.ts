...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.openchamber.sessionRetention.deleteAll.confirm': '삭제 가능한 보관 세션: {count}개. 보호를 위해 제외됨: {protected}개.',
  ...
  'settings.openchamber.sessionRetention.deleteAll.result': '삭제됨: {deleted}개. 남음: {remaining}개. 실패: {failed}개.',
