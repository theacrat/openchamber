...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.openchamber.sessionRetention.deleteAll.title': '보관된 세션 모두 삭제',
  'settings.openchamber.sessionRetention.deleteAll.exclusions': '나이와 관계없이 한 번만 삭제합니다. 선택됨, 실행 중, 대기 중 또는 차단된 세션, 임시 대화가 있는 세션, 보호된 세션이나 보관되지 않은 세션의 상위 세션은 유지됩니다. 고정 세션 유지 설정이 적용됩니다. 실행 취소할 수 없습니다.',
  'settings.openchamber.sessionRetention.deleteAll.confirm': '이 인스턴스에서 삭제 가능한 보관 세션: {count}개. 보호를 위해 제외됨: {protected}개. 확인된 세션은 삭제 전에 다시 확인하며, 새로 보관된 세션은 포함하지 않습니다.',
  'settings.openchamber.sessionRetention.deleteAll.working': '세션을 확인하고 작업을 적용하는 중…',
  'settings.openchamber.sessionRetention.deleteAll.error': '작업을 완료할 수 없습니다. 이 대화 상자를 닫고 다시 시도하세요.',
  'settings.openchamber.sessionRetention.deleteAll.result': '삭제 확인됨: {deleted}개. 검토한 범위에서 삭제가 확인되지 않은 수: {remaining}개. 실패한 요청: {failed}개. 보호되거나 변경된 세션은 유지됩니다.',
  ...
  'settings.openchamber.sessionRetention.field.autoDeleteArchivedPeriod': '보관된 세션 기간',
  'settings.openchamber.sessionRetention.tooltip': '비활성 보관은 마지막 활동을 사용합니다. 보관된 세션 삭제는 보관 후 경과 시간을 사용합니다. 병합 보관과 프롬프트 복원은 별도 정책입니다.',
