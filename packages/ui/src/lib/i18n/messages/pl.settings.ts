...
export const settingsDict = {
  ...
  'settings.openchamber.sessionRetention.deleteAll.result': 'Potwierdzone usunięcie: {deleted}. Niepotwierdzone jako usunięte z przeglądanego zakresu: {remaining}. Nieudane żądania: {failed}. Chronione lub zmienione sesje pozostają.',
