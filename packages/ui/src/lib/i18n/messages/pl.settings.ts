...
export const settingsDict = {
  ...
  'settings.openchamber.sessionRetention.deleteAll.confirm': 'Kwalifikujące się zarchiwizowane sesje: {count}. Wykluczone dla ochrony: {protected}.',
  ...
  'settings.openchamber.sessionRetention.deleteAll.result': 'Usunięte: {deleted}. Pozostałe: {remaining}. Nieudane: {failed}.',
