...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  'settings.openchamber.sessionRetention.field.autoArchivePeriod': 'Idade da sessão inativa',
  ...
  'settings.openchamber.sessionRetention.field.autoDeleteArchivedPeriod': 'Idade da sessão arquivada',
