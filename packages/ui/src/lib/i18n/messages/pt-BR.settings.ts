...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  'settings.openchamber.sessionRetention.deleteAll.title': 'Excluir todas as sessões arquivadas',
  'settings.openchamber.sessionRetention.deleteAll.exclusions': 'Exclusão única, independentemente da idade. Mantém sessões selecionadas, em execução, na fila ou bloqueadas, sessões com conversas temporárias e pais de sessões protegidas ou não arquivadas. A opção de manter sessões fixadas também se aplica. Não é possível desfazer.',
  'settings.openchamber.sessionRetention.deleteAll.confirm': 'Sessões arquivadas elegíveis nesta instância: {count}. Excluídas por proteção: {protected}. As sessões confirmadas são verificadas novamente antes da exclusão; sessões arquivadas recentemente não são incluídas.',
  'settings.openchamber.sessionRetention.deleteAll.working': 'Verificando sessões e aplicando a ação…',
  'settings.openchamber.sessionRetention.deleteAll.error': 'Não foi possível concluir a ação. Feche este diálogo e tente novamente.',
  'settings.openchamber.sessionRetention.deleteAll.result': 'Exclusões confirmadas: {deleted}. Não confirmadas como excluídas do escopo revisado: {remaining}. Solicitações com falha: {failed}. Sessões protegidas ou alteradas são mantidas.',
  'settings.openchamber.sessionRetention.foregroundBoundary': 'As verificações automáticas são executadas enquanto o OpenChamber está aberto.',
  'settings.openchamber.sessionRetention.field.autoArchive': 'Arquivar sessões inativas automaticamente',
  'settings.openchamber.sessionRetention.field.autoArchivePeriod': 'Tempo de inatividade da sessão',
  'settings.openchamber.sessionRetention.field.autoArchiveOnMerge': 'Arquivar sessões quando o pull request de sua branch for mesclado',
  'settings.openchamber.sessionRetention.field.autoUnarchiveOnPrompt': 'Restaurar sessões arquivadas ao receber um prompt',
  'settings.openchamber.sessionRetention.field.excludePinned': 'Manter sessões fixadas',
  'settings.openchamber.sessionRetention.field.autoDeleteArchived': 'Excluir sessões arquivadas automaticamente',
  'settings.openchamber.sessionRetention.field.autoDeleteArchivedPeriod': 'Tempo desde o arquivamento',
  "settings.openchamber.sessionRetention.tooltip": "O arquivamento por inatividade usa a última atividade. A exclusão de sessões arquivadas usa a idade desde o arquivamento. O arquivamento após merge e a restauração ao solicitar são políticas separadas.",
