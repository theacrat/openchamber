...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  'settings.openchamber.sessionRetention.deleteAll.confirm': 'Eligible archived sessions: {count}. Excluded for protection: {protected}.',
  'settings.openchamber.sessionRetention.deleteAll.working': 'Checking sessions and applying the action…',
  'settings.openchamber.sessionRetention.deleteAll.error': 'The action could not finish. Close this dialog and try again.',
  'settings.openchamber.sessionRetention.deleteAll.result': 'Deleted: {deleted}. Remaining: {remaining}. Failed: {failed}.',
