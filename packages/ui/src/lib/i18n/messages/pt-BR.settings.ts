...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  'settings.openchamber.sessionRetention.deleteAll.confirm': 'Sessões arquivadas elegíveis: {count}. Excluídas por proteção: {protected}.',
  ...
  'settings.openchamber.sessionRetention.deleteAll.result': 'Excluídas: {deleted}. Restantes: {remaining}. Falhas: {failed}.',
