...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.sessionRetention.deleteAll.confirm': '符合条件的已归档会话：{count}。因保护而排除：{protected}。',
  ...
  'settings.openchamber.sessionRetention.deleteAll.result': '已删除：{deleted}。剩余：{remaining}。失败：{failed}。',
