...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.sessionRetention.deleteAll.confirm': '此实例中符合条件的已归档会话：{count}。因保护而排除：{protected}。已确认的会话会在删除前再次检查；新归档的会话不包含在内。',
  'settings.openchamber.sessionRetention.deleteAll.working': '正在检查会话并执行操作…',
  'settings.openchamber.sessionRetention.deleteAll.error': '操作未能完成。请关闭此对话框后重试。',
  'settings.openchamber.sessionRetention.deleteAll.result': '已确认删除：{deleted}。在已审核范围内未确认删除：{remaining}。失败请求：{failed}。受保护或已更改的会话会保留。',
