...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.sessionRetention.deleteAll.title': '删除所有已归档会话',
  'settings.openchamber.sessionRetention.deleteAll.exclusions': '一次性删除，不考虑会话年龄。保留当前选中、运行中、排队中或被阻塞的会话、带临时对话的会话，以及受保护或未归档会话的父会话。启用保留固定会话时同样适用。此操作无法撤销。',
  ...
  'settings.openchamber.sessionRetention.field.autoDeleteArchivedPeriod': '已归档会话期限',
  'settings.openchamber.sessionRetention.tooltip': '非活动归档使用最后活动时间。删除已归档会话使用归档后的时间。合并后归档和按提示恢复是独立策略。',
