...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  'settings.openchamber.sessionRetention.deleteAll.confirm': 'Доступні для видалення архівні сеанси: {count}. Виключено для захисту: {protected}.',
  ...
  'settings.openchamber.sessionRetention.deleteAll.result': 'Видалено: {deleted}. Залишилося: {remaining}. Невдало: {failed}.',
