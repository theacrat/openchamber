...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  'settings.openchamber.sessionRetention.deleteAll.title': 'Видалити всі архівні сеанси',
  'settings.openchamber.sessionRetention.deleteAll.exclusions': 'Одноразове видалення незалежно від віку. Зберігає вибрані, активні, поставлені в чергу або заблоковані сеанси, сеанси з тимчасовими розмовами та батьків захищених або неархівних сеансів. Параметр збереження закріплених сеансів також діє. Дію не можна скасувати.',
  'settings.openchamber.sessionRetention.deleteAll.confirm': 'Архівні сеанси, доступні для видалення в цьому екземплярі: {count}. Виключено для захисту: {protected}. Підтверджені сеанси повторно перевіряються перед видаленням; нещодавно архівовані сеанси не включаються.',
  'settings.openchamber.sessionRetention.deleteAll.working': 'Перевірка сеансів і виконання дії…',
  'settings.openchamber.sessionRetention.deleteAll.error': 'Не вдалося завершити дію. Закрийте це діалогове вікно й спробуйте ще раз.',
  'settings.openchamber.sessionRetention.deleteAll.result': 'Підтверджено видалення: {deleted}. Не підтверджено видалення в перевіреній області: {remaining}. Невдалі запити: {failed}. Захищені або змінені сеанси збережено.',
  ...
  'settings.openchamber.sessionRetention.field.autoDeleteArchivedPeriod': 'Вік архівованого сеансу',
  "settings.openchamber.sessionRetention.tooltip": "Архівування неактивних сеансів використовує час останньої активності. Видалення архівних сеансів використовує час архівування. Архівування після злиття та відновлення за запитом є окремими політиками.",
