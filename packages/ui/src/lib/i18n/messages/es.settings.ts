...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  'settings.openchamber.sessionRetention.deleteAll.confirm': 'Sesiones archivadas elegibles: {count}. Excluidas por protección: {protected}.',
  ...
  'settings.openchamber.sessionRetention.deleteAll.result': 'Eliminadas: {deleted}. Restantes: {remaining}. Fallidas: {failed}.',
