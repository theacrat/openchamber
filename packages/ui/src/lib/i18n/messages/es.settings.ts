...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  'settings.openchamber.sessionRetention.deleteAll.title': 'Eliminar todas las sesiones archivadas',
  'settings.openchamber.sessionRetention.deleteAll.exclusions': 'Eliminación única sin importar la antigüedad. Conserva sesiones seleccionadas, en ejecución, en cola o bloqueadas, sesiones con conversaciones temporales y padres de sesiones protegidas o no archivadas. También se aplica la opción de conservar sesiones fijadas. No se puede deshacer.',
  'settings.openchamber.sessionRetention.deleteAll.confirm': 'Sesiones archivadas elegibles en esta instancia: {count}. Excluidas por protección: {protected}. Las sesiones confirmadas se comprueban de nuevo antes de eliminarlas; las archivadas recientemente no se incluyen.',
  'settings.openchamber.sessionRetention.deleteAll.working': 'Comprobando las sesiones y aplicando la acción…',
  'settings.openchamber.sessionRetention.deleteAll.error': 'La acción no pudo terminar. Cierra este diálogo e inténtalo de nuevo.',
  'settings.openchamber.sessionRetention.deleteAll.result': 'Eliminadas con confirmación: {deleted}. No confirmadas como eliminadas del alcance revisado: {remaining}. Solicitudes fallidas: {failed}. Las sesiones protegidas o modificadas se conservan.',
  ...
  'settings.openchamber.sessionRetention.field.autoDeleteArchivedPeriod': 'Antigüedad de la sesión archivada',
  "settings.openchamber.sessionRetention.tooltip": "El archivado por inactividad usa la última actividad. La eliminación de sesiones archivadas usa el tiempo desde el archivado. El archivado tras una fusión y la restauración al recibir un mensaje son políticas independientes.",
