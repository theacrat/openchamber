...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.openchamber.sessionRetention.deleteAll.confirm': '此執行個體中符合條件的已封存工作階段：{count}。因保護而排除：{protected}。已確認的工作階段會在刪除前再次檢查；新封存的工作階段不包含在內。',
  'settings.openchamber.sessionRetention.deleteAll.working': '正在檢查工作階段並執行操作…',
  'settings.openchamber.sessionRetention.deleteAll.error': '無法完成操作。請關閉此對話框後再試一次。',
  'settings.openchamber.sessionRetention.deleteAll.result': '已確認刪除：{deleted}。在已檢閱範圍內未確認刪除：{remaining}。失敗請求：{failed}。受保護或已變更的工作階段會保留。',
