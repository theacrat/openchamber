...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.openchamber.sessionRetention.deleteAll.title': '刪除所有已封存工作階段',
  'settings.openchamber.sessionRetention.deleteAll.exclusions': '一次性刪除，不考慮工作階段年齡。保留目前選取、執行中、排隊中或遭封鎖的工作階段、含暫時對話的工作階段，以及受保護或未封存工作階段的父工作階段。啟用保留釘選工作階段時同樣適用。此操作無法復原。',
  ...
  'settings.openchamber.sessionRetention.field.autoDeleteArchivedPeriod': '已封存工作階段期限',
  'settings.openchamber.sessionRetention.tooltip': '非活動封存使用最後活動時間。刪除已封存工作階段使用封存後的時間。合併後封存與依提示還原是獨立政策。',
