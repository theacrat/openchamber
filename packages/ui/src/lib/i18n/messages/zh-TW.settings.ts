...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.openchamber.sessionRetention.deleteAll.confirm': '符合條件的已封存工作階段：{count}。因保護而排除：{protected}。',
  ...
  'settings.openchamber.sessionRetention.deleteAll.result': '已刪除：{deleted}。剩餘：{remaining}。失敗：{failed}。',
