...
export const settingsDict = {
  ...
  'settings.openchamber.sessionRetention.deleteAll.title': 'Delete all archived sessions',
  'settings.openchamber.sessionRetention.deleteAll.exclusions': 'One-time deletion, regardless of age. Keeps selected, running, queued or blocked sessions, sessions with temporary conversations, and parents of protected or unarchived sessions. Keep pinned sessions applies. This cannot be undone.',
  'settings.openchamber.sessionRetention.deleteAll.confirm': 'Eligible archived sessions across this instance: {count}. Excluded for protection: {protected}. Confirmed sessions are checked again before deletion; newly archived sessions are not included.',
  'settings.openchamber.sessionRetention.deleteAll.working': 'Checking sessions and applying the requested action…',
  'settings.openchamber.sessionRetention.deleteAll.error': 'The action could not finish. Session discovery, another cleanup or an instance change prevented completion. Close this dialog and try again.',
  'settings.openchamber.sessionRetention.deleteAll.result': 'Confirmed deleted: {deleted}. Not confirmed deleted from the reviewed scope: {remaining}. Failed requests: {failed}. Protected or changed sessions are kept.',
  ...
  'settings.openchamber.sessionRetention.field.autoArchiveOnMerge': 'Archive sessions when their branch pull request is merged',
  'settings.openchamber.sessionRetention.field.autoUnarchiveOnPrompt': 'Restore archived sessions when prompted',
  'settings.openchamber.sessionRetention.field.excludePinned': 'Keep pinned sessions',
  'settings.openchamber.sessionRetention.field.autoDeleteArchived': 'Delete archived sessions automatically',
  'settings.openchamber.sessionRetention.field.autoDeleteArchivedPeriod': 'Archived session age',
  'settings.openchamber.sessionRetention.tooltip': 'Inactive archiving uses last activity. Archived deletion uses archive age. Merge archiving and prompt restoration are separate policies. The runner protects the open session, running sessions, recent sessions and protected descendants.',
