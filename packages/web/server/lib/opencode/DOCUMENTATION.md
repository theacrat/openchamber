...
- Prompt and command proxy requests apply the persisted prompt-restoration setting before forwarding and fail closed when archive state or restoration is unavailable.
